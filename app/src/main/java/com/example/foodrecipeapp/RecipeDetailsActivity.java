...
import com.example.foodrecipeapp.Adapter.IngredientsAdapter;
import com.example.foodrecipeapp.Adapter.InstructionsAdapter;
import com.example.foodrecipeapp.Adapter.SimilarRecipeAdapter;
...
public class RecipeDetailsActivity extends AppCompatActivity {
    ...
    private final RecipeDetailsListener recipeDetailsListener = new RecipeDetailsListener() {
        ...
        @Override
        public void didError(String messasge) {
            Toast.makeText(RecipeDetailsActivity.this, messasge, Toast.LENGTH_SHORT).show();
        }
    };
